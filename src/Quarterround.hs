...
We treat the quarterround algebra as an F-Algebra by defining `Mod`, `Rotl` and `Xor` as operations.
This allow us to form quarterround expressions.
-}
module Quarterround
    (
    quarterround
